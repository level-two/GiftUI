...
fixture_root = root.join("Tests/ContractFixtures/SPEC002")
manifest_path = fixture_root.join("fixture-manifest.tsv")

def fail_check(message)
  warn "SPEC-002 fixture manifest check failed: #{message}"
  exit 1
end
...
puts "SPEC-002 fixture manifest check passed: #{rows.length} fixtures."
