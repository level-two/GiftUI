...
declared_inputs() {
    {
        ...
        printf '%s\n' \
            ...
            "$SCRIPT_DIR/check-spec-009-owner-integration.rb" \
            ...
            "$SCRIPT_DIR/check-spec-009-handoff-corpus.rb" \
...
"$SCRIPT_DIR/check-spec-009-execution-failure-adapter.rb" >>"$log_path" 2>&1
record_command "$SCRIPT_DIR/check-spec-009-frame-commit.rb"
"$SCRIPT_DIR/check-spec-009-frame-commit.rb" >>"$log_path" 2>&1
...
record_command "$SCRIPT_DIR/check-spec-009-handoff-corpus.rb"
"$SCRIPT_DIR/check-spec-009-handoff-corpus.rb" >>"$log_path" 2>&1
