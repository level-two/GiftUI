...
expected_sources << File.join(ROOT, "Sources/GiftUI/LayoutValues.swift")
expected_sources << File.join(ROOT, "Sources/GiftUI/LayoutContainers.swift")
expected_sources << File.join(ROOT, "Sources/GiftUI/LayoutModifiers.swift")
...
puts "SPEC-002 migration closure passed: 24 rows, 6 immutable PoC inventories, exact bounded Foundation source plus approved SPEC-006, SPEC-007, SPEC-008, SPEC-010, and SPEC-012 declarations."
