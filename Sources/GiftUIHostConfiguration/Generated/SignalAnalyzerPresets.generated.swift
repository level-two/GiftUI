...
// Source SHA-256: 3fecc980975c86994b3c93a521d4770a26bc2504f6c1257e2ce7896c59a89960
...
package enum GeneratedSignalAnalyzerPresets {
    package static let sourceIdentity = GeneratedHostPresetIdentity(
        word0: 0x3fecc980975c8699, word1: 0x4b3c93a521d4770a,
        word2: 0x26bc2504f6c1257e, word3: 0x2ce7896c59a89960
    )
...
package static func nrf52840Static() -> GeneratedSignalAnalyzerPreset {
    ...
    private static func makePreset(
        ...
        let limits = RuntimeProfileLimits(
            ...
            renderSink: .init(maximumOperations: 150, maximumPositionedGlyphs: 224),
            maximumOrdinaryRenderOperations: 145,
            execution: .init(
        ...
        let workload = SignalAnalyzerHostWorkload(
            ...
            renderTextLineCount: 128,
            positionedGlyphCount: 224,
            ordinaryRenderOperations: 145,
