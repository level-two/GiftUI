...
@Test func generatedPresetsCarryOneFreshCompleteWorkload() {
    ...
    for preset in presets {
        ...
        #expect(preset.workload.layoutScopeOccurrences == 53)
        ...
        #expect(preset.runtimeLimits.renderWorkspace.maximumLayoutScopes == 53)
        #expect(preset.runtimeLimits.renderWorkspace.maximumTraversalDepth == 6)
        #expect(preset.runtimeLimits.renderWorkspace.maximumTextLines == 21)
