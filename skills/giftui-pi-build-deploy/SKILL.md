...
description: Cross-build GiftUI executable products as verified 32-bit ARMv6 Linux binaries and deploy them atomically to a Raspberry Pi 1 over SSH. Use for Raspberry Pi builds, deploys, remote runs, user-service restarts, artifact inspection, or daily Mac-to-Pi development loops.
---
