...
ADRs record architecturally significant decisions extracted from approved
design work. Only an accepted ADR is authoritative architecture.
...
one decision, preserve rejected alternatives, and update `docs/features.yaml`.
