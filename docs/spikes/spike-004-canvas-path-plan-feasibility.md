...
raster algorithm, or authorize reuse of the disposable code. RFC-009 is now in
`review`. Its formerly separate implicit-Canvas-clip blocker was subsequently
