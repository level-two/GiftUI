...
if(NOT DEFINED SPIKE002_SWIFT_SOURCE)
    message(FATAL_ERROR "SPIKE002_SWIFT_SOURCE is required")
endif()
...
if(DEFINED SPIKE002_EXTRA_C_SOURCE)
    target_sources(app PRIVATE "${SPIKE002_EXTRA_C_SOURCE}")
endif()

add_library(app_swift OBJECT "${SPIKE002_SWIFT_SOURCE}")
add_dependencies(app_swift syscall_list_h_target)

if(CONFIG_FP_HARDABI)
    set(spike002_float_abi hard)
elseif(CONFIG_FP_SOFTABI)
    set(spike002_float_abi soft)
else()
...
target_compile_options(app_swift PRIVATE
    ...
    "SHELL:-Xcc -mfloat-abi=${spike002_float_abi}"
