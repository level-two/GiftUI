...
if(NOT DEFINED SPIKE004_SWIFT_SOURCE)
    message(FATAL_ERROR "SPIKE004_SWIFT_SOURCE is required")
endif()
if(NOT DEFINED SPIKE004_VARIANT)
    message(FATAL_ERROR "SPIKE004_VARIANT is required")
endif()
...
target_sources(app PRIVATE
    ...
    "${CMAKE_CURRENT_LIST_DIR}/shared/raster_storage.c"
)
if(DEFINED SPIKE004_STORAGE_SOURCE)
    target_sources(app PRIVATE "${SPIKE004_STORAGE_SOURCE}")
endif()
target_compile_definitions(app PRIVATE "${SPIKE004_VARIANT}=1")
target_compile_options(app PRIVATE -fno-tree-loop-distribute-patterns)

add_library(app_swift OBJECT "${SPIKE004_SWIFT_SOURCE}")
add_dependencies(app_swift syscall_list_h_target)

if(CONFIG_FP_HARDABI)
    set(spike004_float_abi hard)
elseif(CONFIG_FP_SOFTABI)
    set(spike004_float_abi soft)
else()
...
target_compile_options(app_swift PRIVATE
    ...
    "SHELL:-Xcc -mfloat-abi=${spike004_float_abi}"
